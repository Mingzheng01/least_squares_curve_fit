...
EXPONENTIAL_LEAST_SQUARES_OP_CODE = properties_config.get('curve_fit_op_codes','EXPONENTIAL_LEAST_SQUARES_OP_CODE')
LOGARIMTHIC_LEAST_SQUARES_OP_CODE = properties_config.get('curve_fit_op_codes','LOGARITHMIC_LEAST_SQUARES_OP_CODE')
POLYNOMIAL_LEAST_SQUARES_OP_CODE  = properties_config.get('curve_fit_op_codes','POLYNOMIAL_LEAST_SQUARES_OP_CODE')
SINUSOIDAL_LEAST_SQUARES_OP_CODE  = properties_config.get('curve_fit_op_codes','SINUSOIDAL_LEAST_SQUARES_OP_CODE')
...
def exponential_fit(input_directory):
	function_name = replace_me.call_cpp_curve_fit(str(EXPONENTIAL_LEAST_SQUARES_OP_CODE), input_directory, exp_output_directory, -1)
...
def logarithmic_fit(input_directory):
	function_name = replace_me.call_cpp_curve_fit(str(LOGARIMTHIC_LEAST_SQUARES_OP_CODE), input_directory, log_output_directory, -1)
...
def polynomial_fit(input_directory, order):
	function_name = replace_me.call_cpp_curve_fit(str(POLYNOMIAL_LEAST_SQUARES_OP_CODE), input_directory, poly_output_directory, order)
...
def sinusoidal_fit(input_directory):
	function_name = replace_me.call_cpp_curve_fit(str(SINUSOIDAL_LEAST_SQUARES_OP_CODE), input_directory, sin_output_directory, -1)
